...
router.post('/operator/my-venues', auth, isOperator, venueController.createVenue);
...
router.put('/operator/my-venues/:id', auth, isOperator, venueController.updateVenue);
